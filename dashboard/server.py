...
def _make_uploads_dir() -> Path:
    ...
    for candidate in [
        Path.home() / "Downloads" / "J.A.R.V.I.S Uploads",
        Path.home() / "Documents" / "J.A.R.V.I.S Uploads",
        BASE_DIR / "uploads",
    ]:
        try:
...
# ── AES-256-CBC ───────────────────────────────────────────────────────────────
_AES_SALT = b'J.A.R.V.I.S-DASHBOARD-v1'
...
def _ensure_network_access(port: int) -> None:
    ...
    if sys.platform == "win32":
        ...
        port_rule = f"J.A.R.V.I.S Dashboard Port {port}"
        prog_rule  = "J.A.R.V.I.S Dashboard Python"
...
<p>Press <strong style="color:#dde3ed">Remote Control</strong> in J.A.R.V.I.S to get a new QR code.</p>
</div></body></html>""")
...
<p>Connecting to J.A.R.V.I.S…</p>
    ...
    async def serve(self) -> None:
        ...
        print("[Dashboard] Press 'Remote Control' in J.A.R.V.I.S UI to get the QR code.")
        await uvicorn.Server(cfg).serve()
